...
public class AmountWordConveration {
	 ...
	 public static String convertNumberToWords(BigDecimal bd) {
	      ...
	      words.put(80, "Eighty");
	      words.put(90, "Ninety");
	      String digits[] = {"", "Hundred", "Thousand", "Lakh", "Crore","Hundred","Trillion","Quadrillion","Quintillion","Sextillion","Septillion"};
	      while (i < digits_length) {
	          ...
	          if (number > 0) {
	              ...
	              String plural = (counter > 0 && number > 10) ? "" : "";
